(() => {
              ...
              (n.load = function (t, n, i) {
                if (
                  ...
                  var r = Array.prototype.slice.apply(t.stringsElement.children),
                    o = r.length;
                  if (o) for (var a = 0; a < o; a += 1) t.strings.push(r[a].innerHTML.trim());
                }
              ...
              !0 !== this.pause.status
                ? (this.timeout = setTimeout(function () {
                    ...
                    if ("^" === o.charAt(0) && /^\^\d+/.test(o)) {
                      var a = 1;
                      (a += (o = /\d+/.exec(o)[0]).length), (n = parseInt(o)), (e.temporaryPause = !0), e.options.onTypingPaused(e.arrayPos, e), (t = t.substring(0, s) + t.substring(s + a)), e.toggleBlinking(!0);
                    }
                    if ("`" === o.charAt(0)) {
  ...
  })(349))("#heading", { strings: ["Muhammad Fakhri Rizqullah", "I am a front-end developer", "I also do design"], typeSpeed: 60, loop: !0 });
})();
